          ...
          <div class="flex-grow flex items-center justify-center -mt-8 flex-col">
              <header class="-mt-10 mb-10">
                  <div class="flex justify-center flex-row mt-10 items-center">
                      <h1 class="flex font-roboto uppercase text-3xl font-extrabold text-{{ $quote->colour }}-500 tracking-wider">
                          Daily
                      </h1>
              ...
              <div id="container-{{$quote->index}}" class="flex flex-col-reverse xl:flex-row h-5/6 w-4/6 whatever tester relative">
                  <div id="" class="h-1/2 xl:h-full xl:w-1/2 bg-{{ $quote->colour }}-600 px-7 xl:px-20 flex items-center justify-center flex-col">
                          <div id="quote-container-{{$quote->index}}" class="h-4/6 flex flex-col relative justify-center pt-6 pl-5 xl:pt-0 xl:pl-0">
                          ...
                          <div class="w-full font-roboto font-medium text-md xl:text-2xl tracking-wide text-gray-100 border-t pt-4 ml-5 flex">
                          ...
                          <div class="align-bottom text-xs w-full font-roboto tracking-wide text-gray-100 pt-3 pl-3 italic">
                              * May of actually been said by <span id="{{$quote->author}}" class="text-base font-medium"> {{ $quote->author }} </span>
                          </div>
                  </div>
